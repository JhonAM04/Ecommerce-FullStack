...
const Register = () => {
  ...
  return (
    <section className="w-full h-screen flex justify-evenly items-center bg-[#FFE6BD] ">
        <form className="flex flex-col justify-around items-center border-2 border-solid rounded-md shadow-xl w-[400px] h-[fit-content] p-[40px] gap-2 bg-[#FFD8A7]" onSubmit={RegisterFunction} >
          <h1>Registrate!!!</h1>
